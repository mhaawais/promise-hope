  ...
  const achievements = [
    {
      ...
      year: "2020s",
      description:
        "Came out of retirement to rejoin Miles’s pre-owned department and mentor the next generation.",
      icon: "ri-award-line",
    ...
    },
    {
      ...
      year: "2000s–Present",
      description:
        "Over 20 years teaching community financial literacy classes focused on credit, budgeting, and empowerment.",
      icon: "ri-medal-line",
    ...
    },
    {
      ...
      year: 1981,
      description:
        "Represented the Illinois Black Chamber of Commerce in Nassau to expand Black-owned product distribution.",
      icon: "ri-trophy-line",
    ...
    },
    {
      ...
      year: "1980s–2000s",
      description:
        "Received multiple awards for top performance at Miles’s dealership over a decades-long career.",
      icon: "ri-heart-line",
    ...
    },
    {
      ...
      year: "1970s–2000s",
      description:
        "Built a 30+ year career in the beauty industry, becoming a respected voice in Black hair care.",
    ...
    },
    {
      ...
      year: "1969–1970",
      description:
        "Honored for military service as a helicopter supply specialist during the Vietnam War.",
    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-[#1a4280] mb-4">
            Achievements & Recognition
          </h2>
          <p className="text-xl text-gray-600">
            Celebrating a distinguished literary career
          </p>
        </div>
          ...
          {achievements.map((achievement) => (
            ...
            >
              <div className="flex items-center mb-4">
                <div
                  className={`w-12 h-12 bg-gradient-to-r ${achievement.color} rounded-full flex items-center justify-center mr-4`}
                >
                  <i className={`${achievement.icon} text-white text-xl`}></i>
                </div>
                <div className="text-2xl font-bold text-[#1a4280]">
                  {achievement.year}
                </div>
              </div>

              <h3 className="text-xl font-bold text-[#1a4280] mb-2">
                {achievement.title}
              </h3>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-6xl mx-auto">
          <h3 className="text-3xl font-bold text-[#1a4280] mb-8 text-center">
            Career Milestones
          </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {milestones.map((milestone, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-3xl font-bold text-[#1a4280] mb-2">
                  {milestone.number}
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-lg">
              <div className="flex items-center mb-4">
                ...
                />
                <div>
                  <div className="font-semibold text-[#1a4280]">
                    The New York Times
                  </div>
              ...
              <p className="text-gray-700 italic leading-relaxed">
                &quot;Jacob Ken Robinson writes with a profound understanding of
                the human condition. His ability to capture complex emotions in
                simple, beautiful prose is extraordinary.&quot;
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg">
              ...
              <p className="text-gray-700 italic leading-relaxed">
                &quot;One of the most important voices in contemporary
                literature. Jacob&apos;s work will be studied and cherished for
                generations to come.&quot;
              </p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-[#1a4280] to-[#6989b0] rounded-2xl p-8 mt-16 text-center text-white">
          ...
          <p className="text-xl mb-6">
            Jacob is currently working on his next novel, expected to be
            released in the end of 2025. Stay tuned for updates on his upcoming
            literary projects and events.
          </p>
          <a
