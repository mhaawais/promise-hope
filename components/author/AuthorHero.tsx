          ...
          <div className="text-white space-y-6">
            <div>
              ...
              <p className="text-xl text-white/80 leading-relaxed">
                Crafting stories that touch hearts and inspire minds for over 15 years. 
                With 8 bestselling novels and countless readers worldwide, Sarah continues 
                to explore the depths of human experience through her powerful narratives.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex space-x-3">
                <a href="#" className="w-12 h-12 bg-white rounded-full flex items-center justify-center hover:bg-black transition-all duration-300 transform hover:scale-110 cursor-pointer">
