      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-500 max-w-2xl mx-auto">
            Discover the latest masterpiece that&apos;s captivating readers worldwide
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-gray-500 mb-6">
                A profound exploration of human nature and the power of resilience. 
                This captivating novel takes readers on an emotional journey through 
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <span className="font-semibold text-[#1a4280]">Genre:</span> Literary Fiction
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <span className="font-semibold text-[#1a4280]">Published:</span> 2025
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <span className="font-semibold text-[#1a4280]">Rating:</span> 4.9/5
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-[#1a4280]/5 to-[#6989b0]/5 p-6 rounded-lg">
              ...
              <p className="text-white italic">
                &quot;A masterpiece that stays with you long after the final page. 
                The author&apos;s ability to weave emotion and meaning is extraordinary.&quot;
              </p>
              <p className="text-sm text-gray-400 mt-2">- Literary Review Magazine</p>
            </div>
