        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="relative group">
              <div className="relative transform transition-all duration-500 group-hover:scale-105">
                <Image
                  ...
                  width={400}
                  height={400}
                  className={`h-auto w-auto rounded-lg shadow-2xl transition-all duration-500 ${
          ...
          <div className="text-white space-y-6">
            <div>
              ...
              <p className="text-xl md:text-2xl text-orange-300 mb-6">
                Public Speaking: Credit Edition turns financial literacy into an engaging, empowering experience. With humor, clarity, and real-world stories, Jacob Ken Robinson shows how understanding credit isn’t just about numbers—it’s about taking control of your future with confidence and purpose.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 text-lg">
              <div>
                ...
                <span className="ml-2 font-semibold">330</span>
              </div>
              <div>
              ...
              <div>
                ...
                <span className="ml-2 font-semibold">2025</span>
              </div>
              <div>
